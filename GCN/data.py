...
class CoraData(object):
    ...
    def process_data(self):
        ...
        train_mask[idx_train] = True  # 前140个元素为训练集
    ...
    # def load_cition(dataset_str="cora"):
...
if __name__=="__main__":
    # 测试数据集类
    dataroot = "../cora"
    data = CoraData(data_root=dataroot).data
    
    node_feature = data.x / data.x.sum(1, keepdims=True)
    
    normalize_adjacency = CoraData.normalization(data.adjacency)
